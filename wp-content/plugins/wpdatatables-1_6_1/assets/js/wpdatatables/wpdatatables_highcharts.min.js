        ...
        setType: function( type ){
            switch( type ){
                ...
                case 'highcharts_stacked_area_chart':
                    this.options.chart.type = 'area';
                    this.options.plotOptions = { area: { stacking: 'normal' }, series: { dataLabels: { enabled: true }} };
                    break;
                ...
                case 'highcharts_stacked_column_chart':
                    this.options.chart.type = 'column';
                    this.options.plotOptions = { column: { stacking: 'normal' }, dataLabels: { enabled: true, format: '%s' } };
                    break;
